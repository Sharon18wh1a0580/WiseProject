...
import com.rest1.dto.RepeatEmail;
...
/*	@Path("deleteMyProduct/{productId}")
    @DELETE
	...
	@DELETE
    @Produces(MediaType.TEXT_PLAIN)
	public void deleteMyProduct(@PathParam("productId") int productId){
	
			System.out.println("delete..");
			CustomerDAO custDao = new CustomerDAO();
			
			int result = custDao.deleteMyProduct(productId);
			System.out.println("delete product " + result);

			
		}	
	@Path("deleteProductAddedByAdmin/{productId}")
	@DELETE
    @Produces(MediaType.TEXT_PLAIN)
	public void deleteProductAddedByAdmin(@PathParam("productId") int productId){
	
			System.out.println("delete..");
			AdminDAO custDao = new AdminDAO();
			
			int result = custDao.deleteProductAddedByAdmin(Products.class,productId);
			System.out.println("delete product " + result);
    ...
    public String placeOrder(int custId) {
    	...
    	SentemailTLS m = new SentemailTLS();
    	m.efarm(customer);
    ...
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    public String repeatOrder(int custId) throws InterruptedException {
		System.out.println(custId);
		Customer customer = new Customer();
		Cart cart = new Cart();
		CustomerDAO custDao = new CustomerDAO();
		custDao.repeatOrder(custId);
		
		customer=custDao.getcustomerbyid(custId);
		System.out.println(customer);
    	
    	RepeatEmail t = new RepeatEmail();
    	t.efarm(customer);
	...
	public void uploadImage(@FormDataParam("Image") InputStream fileInputStream,
			...
			@FormDataParam("category") String category,@FormDataParam("units") String units, @FormDataParam("uploadedDate") Date uploadedDate,
